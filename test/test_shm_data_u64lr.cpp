...
#define ENDIAN_A endian::host_to_little
#define ENDIAN_B endian::little_to_host
typedef uint64_t       data_type;
typedef SHM_Data_u64lr SHM_data_type;
static const char     *name_prefix = "u64lr_";
...
int main() {
    ...
    for (std::size_t i = 0; i < ITERATIONS; ++i) {
        ...
        for (auto &a : data) {
            ...
            std::swap(reg[0], reg[3]);
            std::swap(reg[1], reg[2]);
            a = d;
        }
